...
外力が働いていないため、運動エネルギー、並進運動量、角運動量は全て保存する。「中心力が働いている時に角運動量が保存する」と、外力が働いていない場合に「角運動量が保存しない」と誤答することが多い。
...
それぞれ、(1)が微小な時間発展、(2)が微小な回転操作に対応している。余裕があれば、この操作によるハミルトニアンの変化が高次となり、それぞれ$J$が保存量であることを示させると良い。
