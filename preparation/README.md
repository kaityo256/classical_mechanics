...
$$
\begin{aligned}
\mathbf{r} \cdot \mathbf{e}_1 &= r_1 \\
\mathbf{r} \cdot \mathbf{e}_2 &= r_2 \\
\mathbf{r} \cdot \mathbf{e}_3 &= r_3
\end{aligned}
$$
...
\begin{aligned}
\mathbf{r} &= r_1 \mathbf{e}_1  +r_2 \mathbf{e}_2+r_3 \mathbf{e}_3\\
&= r'_1 \mathbf{e}'_1  +r'_2 \mathbf{e}'_2+r'_3 \mathbf{e}'_3.
\end{aligned}
$$
...
さて、物理で現れるベクトル空間には、自然な内積が定義できることが多い。内積が定義されたベクトル空間を **内積空間**(inner product space) と呼ぶ。内積とは、ベクトル2つを、1つのスカラーに結びつける写像のことである。既に見たように、縦ベクトルや横ベクトルには自然な内積が定義できるが、関数をベクトルとみなすと、関数同士にも内積を定義することができる。いま、関数$f(x)$と$g(x)$について、その内積を
