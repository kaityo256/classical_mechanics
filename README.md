...
数式があまり出現しないことを売りにするような教科書もあるようだが、この講義ノートでは数式を遠慮なく用いる。また、この講義ノートは教員向けに書いてある。すなわち、黒板に数式や図を書いていくためのノートである。したがって、式番号などは存在しない。式は原則として上から順番に書いていくことを想定している。無論、学生が自習のために用いることは妨げない。
